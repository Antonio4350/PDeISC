...
export default function EditarPerfilScreen() {
  ...
  const guardarPerfil = async () => {
    ...
    if (documentos.length !== 2) return setMensaje("Se requieren exactamente 2 documentos");
    ...
    documentos.forEach((doc, idx) =>
      formData.append("documento", {
        uri: doc,
        type: "image/jpeg",
        name: `documento_${Date.now()}_${idx}.jpg`,
      } as any)
    );
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.mainRow}>
        <View style={styles.leftColumn}>
          ...
          {/* Foto de Perfil */}
          <Image 
            source={{ uri: fotoPerfil || "https://cdn-icons-png.flaticon.com/512/3135/3135715.png" }} 
            style={styles.avatar} 
          />
            ...
            <View style={styles.docRow}>
              {documentos.map((uri, idx) => (
                <View key={idx} style={{ position: "relative" }}>
                  ...
                  <TouchableOpacity style={styles.deleteBtn} onPress={() => eliminarDocumento(idx)}>
