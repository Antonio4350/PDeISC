...
document.getElementById("formularioAnimales").addEventListener("submit", e => {
    e.preventDefault();
    ...
    if (nuevoAnimal === "") {
        ...
        parrafo1.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-red-100 border border-red-400 text-red-700 dark:bg-red-900 dark:border-red-700 dark:text-red-400";
        return;
    }
    ...
    parrafo1.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-green-100 border border-green-400 text-green-700 dark:bg-green-900 dark:border-green-700 dark:text-green-400";
...
document.getElementById("dlAnimal").addEventListener("click", () => {
    ...
    parrafo1.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-yellow-100 border border-yellow-400 text-yellow-700 dark:bg-yellow-900 dark:border-yellow-700 dark:text-yellow-400";
});
...
document.getElementById("formularioSupermercado").addEventListener("submit", e =>{
    e.preventDefault();
    ...
    if (nuevoProducto === "") {
        ...
        parrafo2.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-red-100 border border-red-400 text-red-700 dark:bg-red-900 dark:border-red-700 dark:text-red-400";
        return;
    }
    ...
    parrafo2.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-green-100 border border-green-400 text-green-700 dark:bg-green-900 dark:border-green-700 dark:text-green-400";
...
document.getElementById("dlProducto").addEventListener("click", () => {
    ...
    parrafo2.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-yellow-100 border border-yellow-400 text-yellow-700 dark:bg-yellow-900 dark:border-yellow-700 dark:text-yellow-400";
});

// Manejo del evento para eliminar todos los productos de la lista
document.getElementById("dlLista").addEventListener("click", () => {
    if (productos.length === 0) {
        parrafo2.textContent = "La lista ya está vacía";
        parrafo2.className = "mt-2 px-4 py-2 rounded-lg text-sm text-center bg-red-100 border border-red-400 text-red-700 dark:bg-red-900 dark:border-red-700 dark:text-red-400";
        return;
    }
